...
if window.Debug == 1 % creates smaller window for debugging
          ...
          [window.Number , window.Rect] = PsychImaging('OpenWindow', windowin, window.BGColor, [150 150 1898 1002], [], [], window.StereoMode,window.MultiSample, window.ImagingPipeline);
